...
List<PhaseRecord> phaseRecordFromJson(String str) => List<PhaseRecord>.from(
    json.decode(str).map((x) => PhaseRecord.fromJson(x)));

String phaseRecordToJson(List<PhaseRecord> data) =>
